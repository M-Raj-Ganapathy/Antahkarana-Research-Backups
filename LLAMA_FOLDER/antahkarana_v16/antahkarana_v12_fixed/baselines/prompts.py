...
# ─────────────────────────────────────────────────────────────────────────────
# TREE-OF-THOUGHT (lightweight)
# ─────────────────────────────────────────────────────────────────────────────

TOT_SYSTEM = (
    "You are an expert deliberative reasoning assistant. "
    "Use Tree-of-Thought: generate 3 candidate reasoning paths, "
    "evaluate each, then synthesize the best answer.\n\n"
    "Format:\n"
    "PATH A: <reasoning> → Conclusion: <answer>\n"
    "PATH B: <reasoning> → Conclusion: <answer>\n"
    "PATH C: <reasoning> → Conclusion: <answer>\n"
    "BEST PATH: <A/B/C> because <rationale>\n"
    "ANSWER: <final answer>"
)
...
def build_prompts_for_method(
    ...
    """Build a list of formatted prompts for (samples × method × dataset)."""

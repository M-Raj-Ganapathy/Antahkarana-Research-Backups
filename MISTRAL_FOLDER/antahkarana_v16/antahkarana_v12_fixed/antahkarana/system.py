...
1. Chitta: dense retrieval via sentence-transformers (replaces word overlap)
2. Routing: LLM-based routing for HotpotQA instead of keyword matching
3. Supporting Facts: proper gold SF matching for HotpotQA
4. Pramana/Samsaya: activation counters + confirmed firing
5. Confidence: real calibrated scores from vote fractions
"""
...
MULTIHOP_SYSTEM = (
    ...
    "No reasoning, no explanation in the ANSWER line.\n\n"
    "Format:\n"
    "Step 1: ...\n"
    "Step 2: ...\n"
...
PRAMANA_SYSTEM = (
    ...
    "Revised answer: <if Supported=no give correct answer, if Supported=yes repeat draft>"
)
